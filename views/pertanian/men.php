		 ...
		 <ul class="megamenu skyblue">
			<li><a href="index.html">HOME</a></li>							
			 <li><?= Html::a('Pupuk', ['/pertanian/men']) ?>
				...
				<li class="active"><a href="#">PUPUK</a>
				<div class="megapanel">
					<div class="row">
						<div class="col1">
							<div class="h_nav">
		 ...
		 <div class="col-md-9 product-model-sec">
					 <a href="single.html"><div class="product-grid love-grid">
						...
						<div class="product-info simpleCart_shelfItem">
							<div class="product-info-cust">
								<h4>PUPUK ZA</h4>
								<span class="item_price">187.095</span>
					 ...
					 <a href="single.html"><div class="product-grid love-grid">
						...
						<div class="product-info simpleCart_shelfItem">
							<div class="product-info-cust">
								<h4>PUPUK SP-36</h4>
								<span class="item_price">200.098</span>
								<input type="text" class="item_quantity" value="1" />
								<input type="button" class="item_add items" value="ADD">	
							</div>										
							<div class="clearfix"> </div>
					...
					<a href="single.html"><div class="product-grid love-grid">
						...
						<div class="product-info simpleCart_shelfItem">
							<div class="product-info-cust">
								<h4>PUPUK NPK</h4>
								<span class="item_price">178.000</span>
								<input type="text" class="item_quantity" value="1" />
								<input type="button" class="item_add items" value="ADD">	
							</div>											
							<div class="clearfix"> </div>
					...
					<a href="single.html"><div class="product-grid love-grid">
						...
						<div class="product-info simpleCart_shelfItem">
							<div class="product-info-cust">
								<h4>PUPUK ZK</h4>
								<span class="item_price">287.905</span>
								<input type="text" class="item_quantity" value="1" />
								<input type="button" class="item_add items" value="ADD">
							</div>												
							<div class="clearfix"> </div>
					...
					<a href="single.html"><div class="product-grid love-grid">
						...
						<div class="product-info simpleCart_shelfItem">
							<div class="product-info-cust">
								<h4>PUPUK ZA 2</h4>
								<span class="item_price">187.195</span>
								<input type="text" class="item_quantity" value="1" />
								<input type="button" class="item_add items" value="ADD">
							</div>												
							<div class="clearfix"> </div>
					...
					<a href="single.html"><div class="product-grid love-grid">
						...
						<div class="product-info simpleCart_shelfItem">
							<div class="product-info-cust">
								<h4 class="love-info">PUPUK ZK</h4>
								<span class="item_price">187.985</span>
								<input type="text" class="item_quantity" value="1" />
								<input type="button" class="item_add items" value="ADD">	
							</div>										
							<div class="clearfix"> </div>
				 ...
				 <section  class="sky-form">
					 <div class="product_right">
						 <h3 class="m_2">Categories</h3>
							<div class="tab1">
							 <ul class="place">								
								 <li class="sort">PUPUK</li>
								 <li class="by"><img src="<?= $url ?>do.png" alt=""></li>
									<div class="clearfix"> </div>
							  </ul>
							 <div class="single-bottom">						
									<a href="#"><p>Pupuk A</p></a>
									<a href="#"><p>Pupuk B</p></a>
									<a href="#"><p>Pupuk c</p></a>
									<a href="#"><p>Pupuk D</p></a>
						     </div>
					      <!-- </div>						  
						  <div class="tab2">
							 <ul class="place">								
