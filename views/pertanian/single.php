					 ...
					 <div class="details-left-slider">
						  <ul id="etalage">
							 <li>
								...
								<img class="etalage_thumb_image" src="<?= $url ?>s1.jpg" />
								<img class="etalage_source_image" src="images/s1.jpg" />
								</a>
							 </li>
							 <li>
								<img class="etalage_thumb_image" src="<?= $url ?>s2.jpg" />
								<img class="etalage_source_image" src="images/s2.jpg"/>
							 </li>
							 <li>
								<img class="etalage_thumb_image" src="<?= $url ?>s3.jpg" />
								<img class="etalage_source_image" src="images/s3.jpg" />
							 </li>
							 <li>
								<img class="etalage_thumb_image" src="<?= $url ?>s4.jpg" />
								<img class="etalage_source_image" src="<?= $url ?>s4.jpg" />
							 </li>
							 <div class="clearfix"></div>
						 </ul>
					 </div>
...
<div class="fotter-logo">
	 ...
	 <div class="ftr-info">
	 <p>2015 Agricultural Ecommerce<a href="http://w3layouts.com/"></a> </p>
	</div>
	 <div class="clearfix"></div>
	 </div>
</div>
