...
<div class="header">
     <div class="container">
         <div class="main-header">
              <div class="carting">
                 <ul><li><?= Html::a('Login', ['/site/login']) ?></li></ul>
                 </div>
             <div class="logo">
                 <h3><a href="index.html">AGRICULTURAL</a></h3>
              </div>              
             <div class="box_1">                 
        ...
        <ul class="megamenu skyblue">
            ...
            <li class="grid"><?= Html::a('Pupuk', ['/pertanian/men']) ?>
                ...
                <li><?= Html::a('Pupuk', ['/site/login']) ?><div class="megapanel">
                    <div class="row">
                        <div class="col1">
                            <div class="h_nav">
                                <h4>shop</h4>
         ...
         <div class="caption" >
         <h1>AGRICULTURAL</h1>     
         <p>e-commerce site for industrial agricultural, livestock and fishery products. Now it has turned into a marketplace platform for agriculture, farming and fisheries that involves farmers to jointly market their commodities online.</p>
         </div>
</div>
<!--header-->
             ...
             <div id="tab1" class="tab-grid1">                            
                 <a href="single.html"><div class="product-grid">                     
                        ...
                        <div class="product-img b-link-stripe b-animate-go  thickbox">                         
                            <img src="<?= $url ?>11.jpg" class="img-responsive" alt=""/>
                            <div class="b-wrapper">
                     ...
                     <a href="single.html"><div class="product-grid">
                         ...
                         <div class="product-img b-link-stripe b-animate-go  thickbox">
                            <img src="<?= $url ?>22.jpg" class="img-responsive" alt=""/>
                            <div class="b-wrapper">
                            <h4 class="b-animate b-from-left  b-delay03">                           
                            <button class="btns">ORDER NOW</button>
                            </h4>
                     ...
                     <a href="single.html"><div class="product-grid">
                        <div class="more-product-info"></div>                       
                        <div class="product-img b-link-stripe b-animate-go  thickbox">
                            <img src="<?= $url ?>33.jpg" class="img-responsive" alt=""/>
                            <div class="b-wrapper">
                            <h4 class="b-animate b-from-left  b-delay03">                           
                            <button class="btns">ORDER NOW</button>
                            </h4>
                     ...
                     <a href="single.html"><div class="product-grid">
                        <div class="more-product-info"><span>NEW</span></div>                       
                        <div class="product-img b-link-stripe b-animate-go  thickbox">
                            <img src="<?= $url ?>55.jpg" class="img-responsive" alt=""/>
                            <div class="b-wrapper">
                            <h4 class="b-animate b-from-left  b-delay03">                           
                            <button class="btns">ORDER NOW</button>
                            </h4>
                     ...
                     <a href="single.html"><div class="product-grid">
                        <div class="more-product-info"></div>                       
                        <div class="product-img b-link-stripe b-animate-go  thickbox">
                            <img src="<?= $url ?>66.jpg" class="img-responsive" alt=""/>
                            <div class="b-wrapper">
                            <h4 class="b-animate b-from-left  b-delay03">                           
                            <button class="btns">ORDER NOW</button>
                            </h4>
             ...
             <div id="tab2" class="tab-grid2">
                 <a href="single.html"><div class="product-grid">
                     ...
                     <a href="single.html"><div class="product-grid">
                        <div class="more-product-info"></div>                       
                        <div class="product-img b-link-stripe b-animate-go  thickbox">
                            <img src="<?= $url ?>555.jpg" class="img-responsive" alt=""/>
                            <div class="b-wrapper">
                            <h4 class="b-animate b-from-left  b-delay03">                           
                            <button class="btns">ORDER NOW</button>
                            </h4>
             ...
             <div id="tab3" class="tab-grid3">
                  <a href="single.html"><div class="product-grid">
                     ...
                     <a href="single.html"><div class="product-grid">
                        <div class="more-product-info"></div>                       
                        <div class="product-img b-link-stripe b-animate-go  thickbox">
                            <img src="<?= $url ?>17.jpg" class="img-responsive" alt=""/>
                            <div class="b-wrapper">
                            <h4 class="b-animate b-from-left  b-delay03">                           
                            <button class="btns">ORDER NOW</button>
                            </h4>
...
<div class="fotter-logo">
     ...
     <div class="ftr-info">
     <p>2021 Ecommerce<a href="http://w3layouts.com/"></a> </p>
    </div>
     <div class="clearfix"></div>
     </div>
</div>
